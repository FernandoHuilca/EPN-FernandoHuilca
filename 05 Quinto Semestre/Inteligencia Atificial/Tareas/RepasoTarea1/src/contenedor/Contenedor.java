...
public class Contenedor {
    ...
    public Contenedor(String hostIP, int puerto, String nombreMainContainer) {
        ...
        // Ya tenemos el main contenedor pero está vacío.

        //ADICIONAL: Estas tres lineas pueden ser reemplazadas por una sola, pero mas compleja xd
        //AgentContainer agenteContenedor = jade.core.Runtime.instance().createAgentContainer(new ProfileImpl(null, 1099, null));
    }
    ...
    public boolean agregarAgente(String nombreAgente, String nombreClase,Object[] objetos, AgentContainer contenedorAGuardar) {
        try {
