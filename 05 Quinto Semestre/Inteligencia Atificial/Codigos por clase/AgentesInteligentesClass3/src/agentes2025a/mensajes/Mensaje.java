...
public class Mensaje {
    ...
    public static void enviarMensajeObj(Agent emisor, String receptor, Serializable obj, int tipo, String idConveration){ // no instancio el objeto
        ACLMessage acl = new ACLMessage (tipo);  // lenguaje de comunicacion de agentes, entero para tipo de mensaje
        ...
        try{
            ...
            Logger.getLogger(idConveration); 
        }
